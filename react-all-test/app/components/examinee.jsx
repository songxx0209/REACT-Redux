...
class Examinee extends Component {
  ...
  render() {
    ...
    let dataSource = [];
    if (examdata.examinee.length !== 0) {
      dataSource = examdata.examinee.map((item, i) => {
        return { ...item, key: i, name: item.examinee_name, id: item.examinee_id }
      });
    }
    ...
    return (
      <div className={styles.container}>
        <div className={styles['top-content']}>
          <AddItem btnName={'添加考生'} title={'考生'} onAdd={this.add.bind(this)} />
        </div>
